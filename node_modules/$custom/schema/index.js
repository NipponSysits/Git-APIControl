...
module.exports = {
	...
	DB: function(customer){
		let mongo = mongoose.model(`db.mysql`, mongoose.Schema({ _table: String, _get: Object }));
		// let mongo = mongoose.model(`db.mysql`, mongoose.Schema({ _type: String, mysql: Object }));
		return {
