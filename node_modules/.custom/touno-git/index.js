...
const repos 	= {
	'source': require('pushover')(config.source, { autoCreate: false }),
	'content': require('pushover')(config.content, { autoCreate: false }),
	'folk': require('pushover')(config.folk, { autoCreate: false })
}
...
var control_git = {
    ...
    var def = Q.defer();
		...
		repos[config].exists(path, function(exists){
			if(!exists) {
				repos[config].create(path, function(err){
